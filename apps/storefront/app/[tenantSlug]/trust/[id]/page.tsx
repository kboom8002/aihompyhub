  ...
  return (
    <article className="container mx-auto py-12 text-[var(--theme-text)] px-4 md:px-0 max-w-4xl">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-3xl font-bold font-[family-name:var(--theme-font)] tracking-tight">Verified Document</h1>
      </div>
      ...
      <TrustStrip 
        sources={payload.sources || ['Internal Clinical Database', 'Dermatology Verified']} 
        reviewerName={payload.reviewer || 'R&D Research Center'} 
