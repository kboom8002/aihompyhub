...
export default async function SolutionsIndexPage(props: { params: Promise<{ tenantSlug: string }> }) {
  ...
  return (
    <div className="container mx-auto py-16 px-4 max-w-5xl">
      ...
      <div className="mb-12 border-b border-[var(--theme-border)] pb-8">
        <h1 className="text-4xl font-light tracking-tight font-[family-name:var(--theme-font)] mb-4">솔루션 허브</h1>
        <p className="opacity-70">고민별 상황별 최적의 솔루션을 제안합니다.</p>
      </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        {assets?.map((asset: any) => (
          <Link href={`/${params.tenantSlug}/solutions/${asset.id}`} key={asset.id}>
