...
export default async function TrustIndexPage(props: { params: Promise<{ tenantSlug: string, locale?: string }> }) {
    ...
    <div className="container mx-auto py-16 px-4 max-w-5xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        {assets?.map((asset: any) => (
          <Link href={`/${locale}/${params.tenantSlug}/trust/${asset.id}`} key={asset.id}>
