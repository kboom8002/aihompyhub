...
let MOCK_TOPICS: any[] = [
  { id: 'mock-topic-1', cluster_id: 'mock-cluster-1', tenant_id: 'SYSTEM', title: '여름철 선크림 얼룩 안지우게 어떻게 바르나요?', content_status: 'published', created_at: new Date().toISOString() },
  { id: 'mock-topic-2', cluster_id: 'mock-cluster-1', tenant_id: 'SYSTEM', title: '지성 피부용 가벼운 로션 있나요?', content_status: 'draft', created_at: new Date().toISOString() }
];
